...
class MainMenu(Menu):
    def __init__(self, game):
        ...
        self.state = "Play"
        self.start_x, self.start_y = self.mid_w, self.mid_h - 20
        ...
        self.calculate_cursor_pos("Play", self.start_y)
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Main Menu", 20, self.game.DISPLAY_W/2, self.game.DISPLAY_H/2 - 70)
            self.game.draw_text("Play", 20, self.start_x, self.start_y)
            self.game.draw_text("Screen Calibration", 20, self.screen_calibration_x, self.screen_calibration_y)
